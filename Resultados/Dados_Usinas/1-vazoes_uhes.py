...
for UHE in listaUHES:
    ...
    ## ATUALIZACAO DEZ-2020 - BRUNO JULIANI ##
    #Modificacoes:
    #Ignora vazoes afluentes negativas - preenche com nan
    #Atualiza serie afluente com media movel de 6 horas
    ...
    for row in DF2.itertuples():
        ...
        string2 = ' {:8.2f} {:8.2f}\n'.format(row[1], row[2])
        arq.write(string2)
    print('Salvou o arquivo da UHE - {}!'.format(sigla))
    arq.close()
