...
for index, posto in postos_precip.iterrows():
    ...
    table_hor = table_hor.loc[table_hor['chuva_mm'].first_valid_index():]
    ...
    if dados.empty:
        ...
        print(f'{index+1}/{len(postos_precip)} - {idPosto} - ',
              table_hor['chuva_mm'].first_valid_index(), ' - ',
              table_hor['chuva_mm'].last_valid_index())
