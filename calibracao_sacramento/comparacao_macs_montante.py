...
Simul = Simul.loc['2020':'2021']
Qmon = Qmon.loc['2020':'2021']
Qobs = Qobs.loc['2020':'2021']
PME = PME.loc['2020':'2021']
...
fig.add_trace(go.Scatter(x=Qobs.index, y=Qmon, name="Qmon (m3/s)", marker_color='blue'), row=2, col=1)
...
fig.write_image(f'./param_macs/calibracao_{bn:02d}_{bnome}.png')
