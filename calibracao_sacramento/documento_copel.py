...
fig.add_trace(go.Scatter(x=Simul.index, y=Simul['MACS'], name='Calibração Multi Etapas', marker_color='green'), row=2, col=1)
...
fig.update_layout(legend_title_text='Bacia 15: Águas do Verê')
fig.update_layout(autosize=False,width=1000,height=550,margin=dict(l=30,r=30,b=10,t=10))
fig.write_html(f'./series/calib_{bn:02d}_{bnome}.html')
fig.show()
...
Qsim_ant = Qsim_ant.loc['2019':'2021']
Qobs_ant = Qobs_ant.loc['2019':'2021']
PME = PME.loc['2019':'2021']
...
fig.update_layout(legend_title_text='Bacia 15: Águas do Verê')
fig.update_layout(autosize=False,width=1000,height=550,margin=dict(l=30,r=30,b=10,t=10))
fig.write_image(f'./series/calib_{bn:02d}_{bnome}.png')
fig.show()
...
print('Nash Antigo = ' + str(he.nse(Qsim_ant['qsim_antigo'],Qobs_ant['qjus'])))
print('Log-Nash Antigo = ' + str(he.nse(np.log(Qsim_ant['qsim_antigo']),np.log(Qobs_ant['qjus']))))
print('Log-Nash Antigo 2 = ' + str(hv.evaluator(hv.nse,np.log(Qsim_ant['qsim_antigo']),np.log(Qobs_ant['qjus']))))
print('PBIAS Antigo = ' + str(hv.evaluator(hv.pbias,Qsim_ant['qsim_antigo'],Qobs_ant['qjus'])))
