...
#CALIBRAÇÃO LOG
dt = 0.25
params1 = pd.read_csv('sispshi_parsac_01.csv', index_col='parNome').to_dict('dict')['parLOG']
Qsim1, Qbfp1, Qbfs1, Qtci1, Qtco1 = sacsma2021.simulacao(area, dt, PME, ETP, params1, Qmon=None, estados=None)

#CALIBRAÇÃO MACS
dt = 0.25
params3 = pd.read_csv('sispshi_parsac_01.csv', index_col='parNome').to_dict('dict')['parMACS']
Qsim3, Qbfp3, Qbfs3, Qtci3, Qtco3 = sacsma2021.simulacao(area, dt, PME, ETP, params3, Qmon=None, estados=None)

#CALIBRAÇÃO NASH
dt = 0.25
params4 = pd.read_csv('sispshi_parsac_01.csv', index_col='parNome').to_dict('dict')['parNSE']
Qsim4, Qbfp4, Qbfs4, Qtci4, Qtco4 = sacsma2021.simulacao(area, dt, PME, ETP, params4, Qmon=None, estados=None)

#CALIBRAÇÃO GR5i - NASH
dt = 6
paramsgr = pd.read_csv('sispshi_pargr5_01.csv', index_col='parNome').to_dict('dict')['parValor']
...
# paramsgr2['x3'] = 120
# paramsgr2['x4'] = 10
paramsgr2 = pd.read_csv('sispshi_pargr5_01.csv', index_col='parNome').to_dict('dict')['parManual']
